...
class _$QuizStateImpl implements _QuizState {
  const _$QuizStateImpl({required this.isLoading});
  ...
  @override
  String toString() {
    return 'QuizState(isLoading: $isLoading)';
  }
...
abstract class _QuizState implements QuizState {
  const factory _QuizState({required final bool isLoading}) = _$QuizStateImpl;
